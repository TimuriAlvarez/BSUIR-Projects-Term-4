...
} T_CONTAINER(CONTAINER_TYPE, CONTAINER_DATA_TYPE, T_ELEMENT_POSTFIX);
...
{
	T_CONTAINER(CONTAINER_TYPE, CONTAINER_DATA_TYPE, T_CONTAINER_POSTFIX) container = T_FUNCTION(new, T_CONTAINER(CONTAINER_TYPE, CONTAINER_DATA_TYPE, T_ALLOCATOR_POSTFIX))(1);
...
{
	T_CONTAINER(CONTAINER_TYPE, CONTAINER_DATA_TYPE, T_ITERATOR_POSTFIX) const temp = T_FUNCTION(new, T_CONTAINER(CONTAINER_TYPE, CONTAINER_DATA_TYPE, T_ELEMENT_POSTFIX))(1);
	temp->data = value;
...
void T_CONTAINER(CONTAINER_TYPE, CONTAINER_DATA_TYPE, pop)(T_CONTAINER(CONTAINER_TYPE, CONTAINER_DATA_TYPE, T_CONTAINER_POSTFIX) const container, const TFlag pop_back)
{
	...
	T_FUNCTION(delete, T_CONTAINER(CONTAINER_TYPE, CONTAINER_DATA_TYPE, T_ELEMENT_POSTFIX))(temp);
}
...
{
	if (T_CONTAINER(CONTAINER_TYPE, CONTAINER_DATA_TYPE, is_empty)(container)) return;	/*	TODO:	EXCEPTION	*/
	T_CONTAINER(CONTAINER_TYPE, CONTAINER_DATA_TYPE, T_ITERATOR_POSTFIX) const temp = T_CONTAINER(CONTAINER_TYPE, CONTAINER_DATA_TYPE, at_index)(container, index);
