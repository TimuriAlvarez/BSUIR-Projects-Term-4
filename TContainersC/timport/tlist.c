...
{
	T_CONTAINER(CONTAINER_TYPE, CONTAINER_DATA_TYPE, T_IPRIVATE_POSTFIX) const temp = T_FUNCTION(new, T_CONTAINER(CONTAINER_TYPE, CONTAINER_DATA_TYPE, T_ELEMENT_POSTFIX))(1);
	temp->data = value;
