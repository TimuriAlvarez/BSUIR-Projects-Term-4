...
{
	T_CONTAINER(CONTAINER_TYPE, CONTAINER_DATA_TYPE, T_CONTAINER_POSTFIX) container = T_MEMORY_MANAGER(allocate, T_CONTAINER(CONTAINER_TYPE, CONTAINER_DATA_TYPE, T_ALLOCATOR_POSTFIX))(1);
...
{
	T_CONTAINER(CONTAINER_TYPE, CONTAINER_DATA_TYPE, T_IPRIVATE_POSTFIX) const temp = T_MEMORY_MANAGER(allocate, T_CONTAINER(CONTAINER_TYPE, CONTAINER_DATA_TYPE, T_ELEMENT_POSTFIX))(1);
	temp->data = value;
...
void T_CONTAINER(CONTAINER_TYPE, CONTAINER_DATA_TYPE, pop)(T_CONTAINER(CONTAINER_TYPE, CONTAINER_DATA_TYPE, T_CONTAINER_POSTFIX) const container, const TBool pop_back)
{
	...
	T_MEMORY_MANAGER(deallocate, T_CONTAINER(CONTAINER_TYPE, CONTAINER_DATA_TYPE, T_ELEMENT_POSTFIX))(temp);
}
