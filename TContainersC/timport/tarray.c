...
{
	T_CONTAINER(CONTAINER_TYPE, CONTAINER_DATA_TYPE, T_CONTAINER_POSTFIX) const result = T_MEMORY_MANAGER(T_CONTAINER(CONTAINER_TYPE, CONTAINER_DATA_TYPE, T_ALLOCATOR_POSTFIX), allocate)(1u);
	result->data = T_MEMORY_MANAGER(CONTAINER_DATA_TYPE, allocate)(size);
	result->size = size;
...
{
	T_MEMORY_MANAGER(CONTAINER_DATA_TYPE, deallocate)(container->data);
